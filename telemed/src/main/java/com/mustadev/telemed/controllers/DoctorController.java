...
public class DoctorController {
	...
	public ResponseEntity<List<Doctor>> getAllDoctors(
			@ApiParam(name = "query", value = "requête de recherche") @RequestParam(name = "query", defaultValue = "", required = false) String query,
			@ApiParam(name = "city", value = "limiter la recherche pour cette ville") @RequestParam(name = "city", defaultValue = "", required = false) String city,
			@ApiParam(name = "sort", value = "trier le résultat par rating et reviews", defaultValue = "rating", allowableValues = "rating, reviews") @RequestParam(name = "sort", defaultValue = "rating", required = false) String sort)
			throws ResourceNotFoundException {
		// see
	...
	public ResponseEntity<Doctor> createDoctor(@ApiParam(value = "Doctor", required = true) @RequestBody Doctor doctor)
	...
	public ResponseEntity<Doctor> updateDoctor(@ApiParam(value = "Doctor", required = true) @RequestBody Doctor doctor)
			throws ResourceAlreadyExistsException {
		...
		Doctor result = doctorService.save(old)
				.orElseThrow(() -> new ResourceAlreadyExistsException("could not update" + doctor.toString()));
	...
	public ResponseEntity<Photo> uploadPhoto(@PathVariable("id") String id, @RequestParam("avatar") MultipartFile file)
		...
		// photo.setOwnerId(id);
		photo = photoService.save(photo).orElseThrow(() -> new ResourceNotFoundException("Could Not Save Photo"));
	...
	public ResponseEntity<Photo> getAvatar(@PathVariable("id") String id) throws ResourceNotFoundException {
		Photo photo = doctorService.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("could not find photo with id")).getAvatar();
	...
	public ResponseEntity<Clinic> addClinic(@PathVariable("id") String id, @RequestBody @Valid Clinic clinic)
			throws ResourceNotFoundException {
	...
	public ResponseEntity<Clinic> getClinic(@PathVariable("id") String id) throws ResourceNotFoundException {
		Clinic clinic = doctorService.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("could not find photo with id")).getClinic();
	...
	public ResponseEntity<Clinic> updateClinic(@PathVariable("id") String id, @RequestBody @Valid Clinic clinic)
			throws ResourceNotFoundException, IOException {
		Doctor doctor = doctorService.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("could not find photo with id"));
		Clinic old = doctor.getClinic();
	...
	public ResponseEntity<Photo> addPhoto(@PathVariable("id") String id, @RequestParam("photo") MultipartFile file)
			throws ResourceNotFoundException, IOException {
		Photo photo = new Photo();
		Doctor doctor = doctorService.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("Could Find Doctor: " + id));
	...
	public ResponseEntity<Review> addReview(@PathVariable("id") String id, @RequestBody @Valid Review review)
			throws ResourceNotFoundException {
		...
		review = reviewService.save(review).orElseThrow(() -> new ResourceNotFoundException("Could Not Save Review"));
	...
	public ResponseEntity<Set<Review>> getReviews(@PathVariable("id") String id) throws ResourceNotFoundException {
		Set<Review> reviews = doctorService.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("Could not find Doctor with ID: " + id)).getReviews();
